        ...
        <View style={styles.container}>
            ...
            <View style={styles.weatherContainer}>
                ...
                <View style={{marginLeft: 8}}>
                    <Text style={styles.title}>23º</Text>
            ...
            <View>
                <Text style={styles.title}>
                    9.2
                    <Text style={[styles.subTitle, {paddingLeft: 8}]}>&nbsp;&nbsp; +8k Votes</Text>
                </Text>
                <View style={gs.rowCenter}>
                    {starColors.map((color, index) => {
                        return (
                            <Entypo name='star' size={13} color={color} key={index} style={{marginHorizontal: 2}} />
                        )
                    })}
                </View>
            </View>
